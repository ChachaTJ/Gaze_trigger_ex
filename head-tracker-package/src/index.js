/**
 * 🎯 Head Tracker Module (Bundleable Version)
 * Human.js 기반 head-tracking 마우스 제어
 * 
 * Usage in Vite/Webpack:
 *   import { HeadTracker } from '@gaze/head-tracker';
...
async function init(options = {}) {
    ...
    try {
        human = new Human({
            backend: 'webgl',
            modelBasePath: options.modelsPath || 'https://cdn.jsdelivr.net/npm/@vladmandic/human/models/',
            cacheSensitivity: 0,
            face: {
                enabled: true,
