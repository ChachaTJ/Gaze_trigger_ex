...
const GestureController = (function () {
    ...
    // ============ Configuration ============
    const CONFIG = {
        TAP_MAX_DURATION: 300,      // Max ms for tap gesture
        TAP_MAX_MOVEMENT: 30,       // Max px movement for tap
        SCROLL_THRESHOLD: 15,       // Min px for scroll detection
        SWIPE_THRESHOLD: 100,       // Min px for swipe detection
        SWIPE_SPEED_THRESHOLD: 400, // Min px/s for swipe
        LONG_PRESS_DURATION: 1500,  // Ms for long press
        SCROLL_SENSITIVITY: 2.5,    // Scroll multiplier
    };
